...
```kotlin
implementation("org.cibseven.community.cibseven-api:cibseven-bpm-engine-api:2.2.0")
```

and for DMN only:

```kotlin
implementation("org.cibseven.community.cibseven-api:cibseven-dmn-engine-api:2.2.0")
```
